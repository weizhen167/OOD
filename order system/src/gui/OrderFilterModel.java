 ...
 * 
 */
public class OrderFilterModel extends AbstractTableModel {

    /** row names */
    static List<List<Object>> list = new ArrayList<List<Object>>();

    /** columnNames */
    final String[] columnNames = { "CustomerID", "LastName", "Address", "City",
        "State", "ZipCode", "OrderID", "Paid?", "OrderDate", "PickupDate",
        "BakeryItemID", "BakeryItemName", "BakeryItemCategory", "Quantity",
